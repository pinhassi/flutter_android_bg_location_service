        ...
        if (intent != null) {
            ...
            if (ACTION_PROCESS_UPDATES.equals(action)) {
                ...
                if (result != null) {
                    ...
                    TempUtils.setLocationUpdatesResult(this, locations);
                    TempUtils.sendNotification(this, TempUtils.getLocationResultTitle(this, locations));
                    Log.i(TAG, TempUtils.getLocationUpdatesResult(this));
                }
            }
        }
    }
